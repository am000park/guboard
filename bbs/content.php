...
if(in_array($co_id, $content_arr)) {

    $content_skin_path = get_skin_path($co_id, $co['co_skin']);
    $content_skin_url  = get_skin_url($co_id, $co['co_skin']);

    $skin_file = $content_skin_path.'/'.$co_id.'.php';
